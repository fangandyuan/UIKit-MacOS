#
#  Be sure to run `pod spec lint UIKit-macOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/fangandyuan/UIKit-MacOS"
  ...
  s.source_files = "UIKit-macOS/UIKit-macOS/UIKit"
